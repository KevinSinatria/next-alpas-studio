    ...
    <div className="flex flex-col items-center justify-center w-full px-8 h-screen">
      <Form {...form}>
        <form
          ...
          className="flex flex-col space-y-4 bg-white/20 rounded-lg shadow-lg backdrop-blur p-8 w-full max-w-xl"
        >
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative">
                    <Input
                      type="text"
                      className="bg-white focus-visible:ring-gray-900"
                  ...
                  <div className="relative">
                    ...
                    {showPassword ? (
                      <Eye
                        ...
                        size={32}
                        className="absolute top-[2px] right-1 p-1 rounded-lg transition-all hover:bg-gray-300 cursor-pointer"
                      />
                    ) : (
                      <EyeClosed
                        onClick={() => setShowPassword(!showPassword)}
          ...
          <footer className="w-full flex flex-col gap-8 items-center justify-center">
            <p className="italic text-xs">
              *make sure that youre an admin from ALPAS Studio
            </p>
            <Image
              src="/alpas-dark-logo.svg"
              alt="Alpas Logo"
              width={100}
              height={100}
            />
