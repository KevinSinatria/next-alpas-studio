    ...
    <section className="bg-linear-to-b/oklch from-blue-800/40 to-white/50 pt-14 rounded-3xl ">
      ...
      <section className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div className="space-y-4 leading-relaxed text-base sm:text-lg text-gray-900 dark:text-white/90">
            ...
            <p>
              <strong>ALPAS Studio</strong> adalah ruang kreatif digital yang fokus pada layanan
              desain produk untuk kebutuhan marketing. Kami bantu bisnismu tampil lebih menarik
              lewat desain yang relevan, berkarakter, dan strategis—baik melalui layanan kustom
              maupun pilihan template siap pakai.
            </p>
          </div>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 pb-12  ">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div className="rounded-2xl border border-white/30 bg-white/60 dark:bg-white/10 p-2 shadow-xl backdrop-blur">
            <Image
              src="/fotbar.png" /* ganti dgn foto tim */
              alt="Tim ALPAS"
              width={720}
              height={420}
          ...
          <div className="space-y-4 leading-relaxed text-base sm:text-lg text-gray-900 dark:text-white/90">
            <p>
              <strong>UXINITY</strong> adalah tim di balik layar <strong>ALPAS Studio</strong>,
              gabungan desainer, developer, dan researcher yang punya satu visi: bikin desain yang
              bukan cuma estetik, tapi juga efektif. Kami percaya pengalaman pengguna yang baik
              adalah kunci desain yang berhasil.
            </p>
          </div>
        </div>
      </section>

      <h1 className="w-full flex justify-center items-center text-2xl text-black mt-5 ">Atau Konsultasikan Desainmu dengan Kami Melalui</h1>
                  <div className="w-full flex justify-center items-center gap-6 mt-5">
                      {gambar.map((gambar,i) => 
                        <Image src={gambar} alt={gambar} key={i} width={60} height={60} />
                      )}
                      <Image src='/tiktok.png' alt='kepo' width={100} height={100}/>
                  </div>
        </main>
